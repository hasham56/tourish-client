...
const Payment = () => {
    ...
    return <>{email ? <PaymentForm email={email} budget={budget} /> : <h1>No Data Found</h1>}</>
}
...
const PaymentForm = ({email, budget}) => {
    ...
    return (
        <div className='payment' style={{textAlign: 'center'}}>
            {payment ? 
                <>
                    <h1>Thank you for you payment. You will recieve a confirmation email shortly at {email}.</h1>
                ...
                <>
                    ...
                    <h4>After Adding Package: {budget === 'affordable' ? '15,000/-' : (budget === 'premium' ? '17,000/-' : '18,000/-')}</h4>
